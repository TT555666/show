...
interface TagListProps extends RouteComponentProps{
    ...
    closeOtherTags: Function
}
class TagList extends Component<TagListProps> {
    tagListContainer = React.createRef() as any
    contextMenuContainer = React.createRef() as any
    state = {
        left: 0,
        top: 0,
        menuVisible: false,
...
const TagListApp:any= withRouter(
    connect((state:State) => state.tagsView, {
        deleteTag,
        emptyTaglist,
        closeOtherTags,
    })(TagList),
